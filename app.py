...
with tab1:
    st.subheader("読解・理解力")
    st.write("【課題】指示書：『作業前に必ず安全靴を履き、バケツに3分の1の水を入れてください。』")
    r_sel = st.selectbox("指示の内容はどのくらい理解できましたか？", 
                           ["-- 選択してください --", "完璧に理解した", "だいたい理解した", "少し不安がある", "全くわわからなかった"], key="r_s")
    r_txt = st.text_area("【記述】具体的に、まず何を準備しますか？", placeholder="例：安全靴を履いてから、バケツに少し水を入れます。", key="r_t")
